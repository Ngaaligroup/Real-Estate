...
// get land properties...
  ...
  surveref.once("value").then(function(snapshot) {
    var first_surveyor = true;
    snapshot.forEach(function(childSnapshot) {

      var active_class = "";
      //catering for the first carousel item to add the active class to it
      if(first_surveyor) {active_class = "active";}

      //then set first property variable to false for the other properties that follow
      first_surveyor = false;
      ...
      append(        
        '<div class="carousel-item '+ active_class +'">'+
         '<div class="col-md-6 col-12 single-surveyor">'+
             '<div class="card " style="width:auto;">'+
                 '<div class="image property-img-container">'+
  ...
  archetref.once("value").then(function(snapshot) {
    var first_architect = true;
    snapshot.forEach(function(childSnapshot) {

      var active_class = "";
      //catering for the first carousel item to add the active class to it
      if(first_architect) {active_class = "active";}

      //then set first architect variable to false for the other properties that follow
      first_architect = false;
      ...
      append(
        '<div class="carousel-item '+ active_class +'">'+
         '<div class="col-md-6 col-12 single-architect">'+
             '<div class="card " style="width:auto;">'+
                 '<div class="image property-img-container">'+
  ...
  civilref.once("value").then(function(snapshot) {
    var first_civil = true;
    snapshot.forEach(function(childSnapshot) {

      var active_class = "";
      //catering for the first carousel item to add the active class to it
      if(first_civil) {active_class = "active";}

      //then set first listing variable to false for the other properties that follow
      first_civil = false;
